...
export const EAST_SUSSEX_GALLERY: PhotoStripItem[] = [
  ...
  { slug: '02-centre-court', title: 'Outdoor padel courts surrounded by English woodland', location: 'Crafted Padel Club' },
  { slug: '03-main-house', title: 'The estate grounds, lawn and outdoor pool', location: 'Crafted at Powdermills' },
  ...
  { slug: '06-the-suite', title: 'A guest suite with handcrafted headboard and warm textiles', location: 'Guest suite' },
  { slug: '07-wellness-gym', title: 'Fitness centre with running track and strength equipment', location: 'Wellness gym' },
  { slug: '08-the-restaurant', title: 'The Orangery restaurant with leafy botanical dining', location: 'Estate restaurant' },
  ...
  { slug: '12-lakeside-sauna', title: 'Panoramic lakeside sauna looking out over the water', location: 'Lakeside wellness' },
  ...
  { slug: '15-the-bar', title: 'Evening drinks in the mural-lined cocktail lounge', location: 'Crafted bar' },
